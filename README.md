...
Le déroulement de ce défi s'est articulé autour de trois journées intenses mobilisant des compétences variées, allant de la sociologie à l'analyse de données. Après une phase initiale de tâtonnements pour définir une problématique pertinente parmi la multitude de sujets possibles, l'équipe s'est structurée autour de rôles précis pour traiter la littérature scientifique et les bases de données. Le deuxième jour a marqué un tournant critique du projet, nous obligeant à abandonner une première direction artistique jugée trop originale pour refondre intégralement notre poster vers un format plus institutionnel et rigoureux. Cette dynamique collective nous a finalement permis de produire des datavisualisations complètes et de finaliser notre présentation orale lors de la troisième matinée, transformant les doutes initiaux en une réalisation concrète et documentée.
